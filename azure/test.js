...
const app = express();
const connectionString = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:cclrms.database.windows.net,1433;Database=rms;Uid=Test;Pwd={admin@123};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;";
